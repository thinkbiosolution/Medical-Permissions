...
/// @title InterfacePatientPermissionRecords
/// Allows Permission Record System to maintain records of patients permission in their network.
/// Records can be accessed by CROs if and only if patient provides name.
...
contract InterfacePatientRecords {
    ...
    */
    ...
    function addRecord(
        ...
        uint256 _typeOfMedicalData) public;
